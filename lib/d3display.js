...
export default class D3Display {
  ...
  updateDatapoints = () => {
    ...
    //     return i <= 20 && el.mode === mode
    //   })) // currently selecting less than 20 songs in DB and only songs in Major Keys
    //   .join('g')
    //   .attr('class', '.songPositions');
    // songPositions
    //   .append('circle')
    ...
    //   .call(wrap, 60);
      ...
      //   toggleSwitch.append('label').text((d) => d);
      //   toggleSwitch
      //     .append('input')
      //     .attr('type', 'checkbox')
      //     .attr('checked', true)
      //     .attr('name', 'toggleSwitch')
      //     .attr('value', 'major')
